...
The project is using SharpDX with DirectX 11 settings. A video of an older state (21.06.2015) is available on YouTube: https://youtu.be/Y96cWqCfFH8
...
## Resources
I mainly used and comined ideas from the following papers:
...
However, there are a few more notable articles, mostly describing different alternative ways to render grass:
